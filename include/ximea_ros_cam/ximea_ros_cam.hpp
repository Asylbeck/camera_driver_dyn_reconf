...
#include <ximea_ros_cam/ximea_ros_camConfig.h>
...
class XimeaROSCam : public nodelet::Nodelet {
 ...
 private:
     ...
     */
    void initTimers();
    void initDynamicReconfig(ros::NodeHandle n);
    void ReconfigCb(ximea_ros_camConfig& config, uint32_t level);
    /**
    ...
    dynamic_reconfigure::Server<ximea_ros_camConfig> srv_;
